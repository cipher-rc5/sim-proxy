/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 39bc2e700890c528236bd9ec02cf07c5)
// Runtime types generated with workerd@1.20250617.0 2025-06-10
declare namespace Cloudflare {
  interface Env {
    NODE_ENV: 'production';
    DUNE_SIM_API_KEY: string;
...
type R2Objects =
  & { objects: R2Object[], delimitedPrefixes: string[] }
...
type AutoRagAiSearchRequest = AutoRagSearchRequest & { stream?: boolean };
...
type ImageInfoResponse = { format: 'image/svg+xml' } | {
  format: string,
  fileSize: number,
  width: number,
  height: number
